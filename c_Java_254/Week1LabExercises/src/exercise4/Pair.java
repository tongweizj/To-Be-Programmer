...
public class Pair<A,B> {
  ...
  public static void main(String[] args) {
    ...
    System.out.print("bidSD:" + bid.toString());
    
    // using Java6 style without type inference:
    bid = new Pair<String,Double>("ORCL", 132.07);  // give explicit types
    System.out.print("\nbidSD:" + bid.toString());
    ...
    */
    ...
    // <String, String>
    Pair<String,String> bidSS = new Pair("MaMa", "BaBa");
    System.out.print("\nbidSS:" + bidSS.toString());
    
    // <Inter, Inter>
    Pair<Integer,Integer> bidII = new Pair(1981, 0);
    System.out.print("\nI am bron at " + bidII.getFirst());
    bidII = new Pair(2024, 43);
    System.out.print(". Now is " + bidII.getFirst() + " year, I am " + bidII.getSecond() + " years.");
