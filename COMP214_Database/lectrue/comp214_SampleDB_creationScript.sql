...
---------------------------------------------------------------------------
-- Create a separate, second 'DB Connection' using the same set of credentials
-- Delete any previous tables, that are NOT included in this script. 

-- Execute the following statements to create a new, second set of tables
---------------------------------------------------------------------------
-- regions
