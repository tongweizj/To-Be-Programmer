...
public class LinkedPositionalList<E> implements MyPositionalList<E> { 
	// 内部链表节点 
...
public static void main(String[] args) { 
	...
	// Test for normal
	System.out.println((list).findPosition("B") == p2); // true 
	System.out.println(list.findPosition("C") == p3); // true 
	
	// Test: can not find 
	System.out.println(list.findPosition("D") == null); // true 
	
	// Test: empty list 
	LinkedPositionalList<Integer> emptyList = new LinkedPositionalList<>(); 
	System.out.println(emptyList.findPosition(5) == null); // true 
